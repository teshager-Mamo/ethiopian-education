...
const DataUpload = () => {
  ...
  const handleDataUpload = (uploadedData) => {
    ...
    const highSchoolColumns = ['english', 'math', 'civic', 'average', 'predictioclass', 'absent', 'rank'].map(normalizeColumnName);
    ...
    if (isHighSchool) {
      ...
      alert(
        ...
        '- HighSchool: English, Math, Civic, Average, Predictioclass, Absent, Rank\n' +
